...
const { buildFvgContext } = require("../knowledgeBase/contextBuilder");
...
function gatherFVGBrainInputs(db, { symbol, interval }) {
  ...
  const { context: fvgContext } = buildFvgContext(db, symbol);
  ...
  return {
    ...
    liquidity,
    context,
    exhaustionLookback: fvgContext.exhaustionLookback,
  };
}
