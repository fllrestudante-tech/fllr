...
// Versão do SCHEMA de saída (não do arquivo) -- consumida pelo Commit
// 4a/4c (assessmentKey), pra que uma mudança futura no formato exigido do
// AgentRouter invalide chaves de avaliação antigas em vez de reconciliar
// contra um contrato diferente. Bump manual sempre que required/properties
// mudar de forma. Não afeta o schema em si.
...
module.exports = { getAgentRouterAssessmentSchema, SCHEMA_VERSION };
