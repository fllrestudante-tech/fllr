  ...
  while (i < candles.length) {
    ...
    if (!blockedByCircuitBreaker && (signals[i] === "buy" || signals[i] === "sell")) {
      ...
      for (let j = i + 1; j <= lastIndex; j++) {
        ...
        // Break even/trailing avaliados DEPOIS da checagem de stop/alvo deste
      ...
      if (outcome === "target") {
        ...
        // exitStopPrice pode ser o stop original, a entrada (breakeven) ou um
        // nível ratcheado pelo trailing -- calcula o retorno real em vez de
        // assumir perda cheia sempre.
