...
const MAX_HOLD_CANDLES = 120; // ~2h em candles de 1m — fecha a mercado se nem stop nem alvo forem atingidos
...
module.exports = { run, simulate, sampleParams, buildSignals, computeMetrics, isCandidateBetter };
