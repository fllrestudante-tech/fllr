...
// Versão do PROMPT (não do arquivo) -- identifica a forma estrutural do
// prompt enviado ao AgentRouter. Consumida pelo Commit 4a/4c (assessmentKey)
// pra que uma mudança futura de SYSTEM_PROMPT/buildPrompt invalide chaves de
// avaliação antigas em vez de reconciliar silenciosamente contra um prompt
// diferente. Bump manual sempre que a FORMA do prompt mudar (não a cada
// ajuste de texto trivial). Não afeta o conteúdo do prompt em si.
