...
const DEFAULT_STATE = {
  ...
  // AI Gateway (integração com o loop, 2026-08-11) -- lastAiCallAt/
  // lastAiContextHash alimentam lib/aiGateway/decisionCyclePolicy.js (piso
  // de tempo + cost-guard por hash). lastAiAssessment é só o último AI
  // Assessment pra inspeção/log -- shadow-only, nunca lido por
  // lib/risk.js/lib/tradeLifecycle.js nem usado em canExecute/planOrder.
  lastAiCallAt: null,
