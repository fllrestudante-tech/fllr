...
// Lê UM objeto JSON de stdin: {"statusCode": 200, "body": {...}}. Nunca
// lança pra entrada malformada -- JSON inválido ou campos ausentes só
// reprovam (imprime "false"). Imprime exatamente "true" ou "false" (sem
// mais nada) em stdout e sempre sai com código 0 -- a decisão vai no
// texto, não no exit code, pra ficar simples de capturar em uma linha do
// PowerShell.
...
process.stdin.on("end", () => {
  ...
  process.stdout.write(isHealthResponseReady(parsed) ? "true" : "false");
});
