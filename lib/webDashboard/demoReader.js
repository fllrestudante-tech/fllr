...
function readDemo({
  ...
  // shadow -- já produziu pelo menos uma avaliação (o AI Gateway em si é
  // SEMPRE shadow-only, nunca aprova ordem, ver comentário de
  // index.js::maybeRunAiAssessment); offline -- nunca rodou ainda ou o
  // provider não está configurado. Nunca um terceiro rótulo.
  const agentRouterStatus = tradingRaw.lastAiAssessment ? "shadow" : "offline";
